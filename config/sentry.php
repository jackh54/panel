...
return [
    ...
    // The release version of your application (shared with the React client).
    // Prefer SENTRY_RELEASE; otherwise panel@{config/app.php version} after a release bump.
    'release' => env('SENTRY_RELEASE') ?: (static function (): ?string {
    ...
    // Default 0.1 so tracing is on once a DSN is configured.
    'traces_sample_rate' => env('SENTRY_TRACES_SAMPLE_RATE', '0.1') === ''
        ? null
        : (float) env('SENTRY_TRACES_SAMPLE_RATE', 0.1),
